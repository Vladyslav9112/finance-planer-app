...
const earningsMarker = (earningsId) => `[earnings:${earningsId}]`;
const toSalaryComment = (earningsId, comment) => [earningsMarker(earningsId), comment?.trim()].filter(Boolean).join(" ");
